...
void loop() {
  ...
  char radiopacket[9] = "Pot = ";
  float measureout = analogRead(OUT_1);      // Read from pot
  measureout *= 3.3;
  measureout /= 1024;
  dtostrf(measureout, 3, 1, radiopacket);    // Convert float pot measurement to array
  //itoa(measureout, radiopacket+9, 10);
